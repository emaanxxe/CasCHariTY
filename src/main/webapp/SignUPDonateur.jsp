...
<body>
	...
	<c:if test="${ !empty donateur.name }"><p><c:out value="Bonjour, vous vous appelez ${ donateur.name }" /></p></c:if>
	
	<div class="container">
    	<div class="heading">Sign Up</div>
			<form class="form" action="SignUPDonateur" method="post">
			    <input  class="input" type="text" name="name" placeholder="Name" required="">
			    <input  class="input" type="text" name="email" placeholder="Email" required="">
			    <input  class="input" type="password" name="password" placeholder="Password" required="">
			    <input  class="input" type="text" name="phone" placeholder="Phone Number" required="">
			    <input  class="input" type="text" name="adresse" placeholder="Address" required="">
			    
    			<input value="Create Account" type="submit" class="login-button" />
    			
			</form>
			<div class="social-account-container">
    			<span class="title">Already you have an Account? <span><a href="SignINDonateur.jsp">Sign In</a></span></span>
    		</div>
