...
<body>
	...
	<div class="container">
    	<div class="heading">Sign In</div>
			<form class="form" action="SignINAdmin" method="post">
			    
			    <input  class="input" type="text" name="CasID" placeholder="CAS Id" required="">
			    <input  class="input" type="text" name="CasEmail" placeholder="Email" required="">
			    <input  class="input" type="password" name="CasPass" placeholder="Password" required="">
