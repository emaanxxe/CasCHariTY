  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="#back1">Donations</a></li>
        <li><a href="newDonation.jsp">New Donation</a></li>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="well" id="back1">
            <h4>Donations</h4>
            <h5><c:out> ${ DonationCount }</c:out></h5> 
          </div>
        </div>
      </div>
